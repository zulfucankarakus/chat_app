package com.example.quickchatapp0.Activity;
...
import com.example.quickchatapp0.ModelClass.Users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String status="Hey There Im Using This Application";
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                if (imageUri!=null){
                                    ...
                                    String status="Hey There Im Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/quickchatapp0.appspot.com/o/profile_image.png?alt=media&token=b90ba93c-24db-4fe9-bfea-2f6902db486a";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
